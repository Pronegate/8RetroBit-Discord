...
Il server riflette esattamente questo modo di essere: si parla di retrogaming e retrocomputing con la stessa serietà con cui si discute dell'ultimo tripla A o dell'hardware più recente, si smanetta col modding degli smartphone Android, si scrive codice e si discute di sviluppo software, ci si confronta su distro Linux e si seguono progetti open source lasciati a metà su GitHub. Non sono cose diverse — è la stessa curiosità applicata a oggetti diversi.
